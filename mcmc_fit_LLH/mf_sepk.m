...
if nargin < 2
    ...
    ms.p_min = [(0.00001*ones(1,c_num)) (0.001*ones(1,c_num)) 0.00001 0.001 (0.00001*ones(1,c_num)) (0.001*ones(1,c_num))   0   0   0 (-5*ones(1,2*c_num+1))   0];
    ms.p_max = [   (1000*ones(1,c_num))    (10*ones(1,c_num))    1000    10    (1000*ones(1,c_num))    (10*ones(1,c_num))   1   1   1  (5*ones(1,2*c_num+1)) 0.2];
    ms.p_ini = [              k_vis_ini    (0.25*(1-cs.^2.2))      40  0.25              k_comb_ini    (0.25*(1-cs.^1.5)) 0.2 0.2 0.2     zeros(1,2*c_num+1)   0];
